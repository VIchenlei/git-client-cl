...
import {windDef} from '../def/gas_pos_def.js'

export default class OlMapWindLayer extends OlMapWorkLayer {
  ...
  registerGlobalEventHandlers () {
    ...
    xbus.on('ENVIRONMENTAL-DATA-UPDATE', () => {
      if (this.layerVisible) { // 图层可见时更新数据
        updateTextData(windDef, this.source)
      }
    })
  }
}
